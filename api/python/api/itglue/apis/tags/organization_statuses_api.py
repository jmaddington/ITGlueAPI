...
from itglue.paths.organization_statuses_id.get import ShowOrganizationStatus
from itglue.paths.organization_statuses_id.patch import UpdateOrganizationStatus


class OrganizationStatusesApi(
