...
# body param
SchemaForRequestBodyApplicationVndApijsonCharsetutf8 = OrganizationType


request_body_organization_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijsoncharsetutf8 = OrganizationType
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_organization_type_oapg(
        self,
    ...
    def _update_organization_type_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_organization_type.serialize(body, content_type)
...
class UpdateOrganizationType(BaseApi):
    ...
    def update_organization_type(
        ...
        return self._update_organization_type_oapg(
            body=body,
