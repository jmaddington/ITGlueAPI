...
# body param
SchemaForRequestBodyApplicationVndApijsoncharsetutf8 = OrganizationStatus


request_body_organization_status = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijsoncharsetutf8 = OrganizationStatus
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_organization_status_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndApijsoncharsetutf8,],
    ...
    def _update_organization_status_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_organization_status.serialize(body, content_type)
...
class UpdateOrganizationStatus(BaseApi):
    ...
    def update_organization_status(
        ...
        return self._update_organization_status_oapg(
            body=body,
