...
# Query params
FilterSchema = OrganizationStatus
...
class SchemaFor200ResponseBodyApplicationVndApijsoncharsetutf8(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrganizationStatus']:
                        return OrganizationStatus
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['OrganizationStatus'], typing.List['OrganizationStatus']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'OrganizationStatus':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _index_organization_statuses_oapg(
        self,
...
class IndexOrganizationStatuses(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def index_organization_statuses(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def index_organization_statuses(
        ...
        return self._index_organization_statuses_oapg(
