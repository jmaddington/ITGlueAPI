...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = "filter_example" # str | Must be a hash (optional)
filter_id = 3.14 # int, float | Organization ID (optional)
filter_name = "filter[name]_example" # str | Name of organization (optional)
organization = Organization(
    ...
    ) # Organization | Get a list of organizations in your account. (optional)

    try:
        # Returns a list of organizations in your account.
        api_response = api_instance.index_organizations(filter=filterfilter_id=filter_idfilter_name=filter_nameorganization=organization)
        pprint(api_response)
